...
<section class="app-user-list">
  <div class="row">
    <div class="col-lg-3 col-sm-6">
      <div class="card">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div>
            <h3 class="fw-bolder mb-75">{{count($empresas)}}</h3>
            <span>{{__('Total companies')}}</span>
          </div>
    ...
    <div class="col-lg-3 col-sm-6">
      <div class="card">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div>
            <h3 class="fw-bolder mb-75">{{$total_empresas_inac}}</h3>
    ...
    <div class="col-lg-3 col-sm-6">
      <div class="card">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div>
            <h3 class="fw-bolder mb-75">{{$total_empresas_acti}}</h3>
    ...
    <div class="row">
      <div class="col-lg-3 col-sm-6">
        <a href="{{route('admin.grupoEmpresarial.create')}}">
          <span class="btn btn-primary mb-1">{{__('New Company')}}</span>
        </a>
      </div>
    </div>
  @endcan
        ...
        <tbody>
          @foreach($empresas as $empresa)
            <tr>
              <td>
                  <div class="avatar">
                    {!! ($empresa->logo != '' ? '<img style="width: 75px; height: 75px;" src="/images/gruposEmpresariales/grupo'.$codGrupoEmpresarial.'/logoEmpresa/'.$empresa->logo.'">' : '')!!}
                  </div>
              </td>
              <td>{{ $empresa->nombre}}</td>
              
              <td>
                @if($empresa->estatus == 'A')
 ...
 <div class="mb-5">
 {{ $empresas->appends(['page' => $request->page, 
