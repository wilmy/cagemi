...
<div class="modal-content">
    <div class="modal-body px-5 pb-5">
        <div class="text-left mb-4">
            <h1 class="role-title">{{__('New employe')}}</h1>
        </div>

        <form id="addRoleForm" method="POST" class="row" enctype="multipart/form-data"
            action="{{route('admin.empleadosxposiciones.store')}}">
            @csrf
            ...
            <input type="hidden" id="grupo"
                value="{{Crypt::encrypt($empresas[0]->cod_grupo_empresarial, false, env('APP_ENCRYPTION'))}}"
                name="grupo">

            <div class="form-group row">
                <div class="mb-1 col-md-4">
                    <label for="register-foto" class="form-label">{{__('Foto')}}</label>
            ...
            <div class="form-group row">
                ...
                <div class="mb-1 col-md-4">
                    ...
                    <input type="text" class="form-control @error('apellido') is-invalid @enderror"
                        ...
                        tabindex="1" autofocus value="{{ old('apellido') }}" />
                    @error('apellido')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group row">
                ...
                <div class="mb-1 col-md-4">
                    ...
                    <input type="text" class="form-control @error('documento') is-invalid @enderror"
                        ...
                        tabindex="1" autofocus value="{{ old('documento') }}" />
                    @error('documento')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group row">
                ...
                <div class="mb-1 col-md-4">
                    ...
                    <input type="text" class="form-control @error('telefono_institucional') is-invalid @enderror"
                        ...
                        value="{{ old('telefono_institucional') }}" />
                    @error('documento')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group row">
                ...
                <div class="mb-1 col-md-4">
                    ...
                    <div class=" mb-1">
                        ...
                        <input type="hidden" value="" id="cod_supervisor" name="cod_supervisor">
                        @error('documento')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-4 text-center mt-2">
                    <a href="{{route('admin.empleadosxposiciones.index')}}"
                        class="btn btn-outline-danger waves-effect waves-light">
                        {{__('Cancel')}}
                    </a>
                    <button type="submit" class="btn btn-primary waves-effect waves-light me-1"
                        onclick="backblock()">{{__('Save')}}</button>
                    ...
                    <tr class="odd">
                        ...
                        <td class="sorting_1">
                            <div class="d-flex justify-content-left align-items-center">
                                ...
                                <div class="d-flex flex-column"><span class="fw-bolder nombre_super"> </span><small
                                        class="emp_post text-muted posicion_super"> </small>
                                </div>
                    ...
                    <tr class="odd">
                        ...
                        <td class="sorting_1">
                            <div class="d-flex justify-content-left align-items-center">
                                ...
                                <div class="d-flex flex-column"><span class="fw-bolder nombre_super">ADRIÁN NEFTALI
                        ...
                        <td>
                            <button class="btn btn-icon btn-primary waves-effect waves-light botonPlus" type="button"
                                id="bt_169" data-bs-dismiss="modal"><span><i data-feather="plus"></i></span></button>
                        </td>
                    </tr>
                </tbody>
            </table>
