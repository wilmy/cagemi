...
<div class="modal-content">
    <div class="modal-body px-5 pb-5">
        ...
        <form id="addRoleForm" method="POST" class="row" enctype="multipart/form-data"
            action="{{route('admin.posicionesxdepartamentos.store')}}">
            @csrf
                ...
                <div class="mb-1 col-md-4">
                    ...
                    <select name="departamento" class="form-select">
                        ...
                        <option value="{{$departamento->cod_departamento}}">
                            {{__($departamento->nombre_departamento.' - ' .$departamento->vicepresidencia->nombre_vicepresidencia.' ('.$departamento->vicepresidencia->empresa->nombre.')')}}
                        </option>
                        @endforeach
                    </select>
                    @error('cominidad')
